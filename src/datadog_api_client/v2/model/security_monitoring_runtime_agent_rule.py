...
class SecurityMonitoringRuntimeAgentRule(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expression (str): A Runtime Security expression determines what activity should be collected by the Datadog agent. These logical expressions can use predefined operators and attributes. Tags cannot be used in Runtime Security expressions (instead, allow/deny based on tags under the advanced option).. [optional]  # noqa: E501
        """
